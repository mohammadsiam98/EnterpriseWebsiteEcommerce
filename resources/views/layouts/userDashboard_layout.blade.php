                    ...
                    <nav class="sidebar-main">
                        ...
                        <div id="sidebar-menu">
                            <ul class="sidebar-links" id="simple-bar">
                                ...
                                <li class="sidebar-list">
                                    <label class="badge badge-danger">Profile</label><a class="sidebar-link sidebar-title" href="#"><i data-feather="box"></i><span>Edit Account</span></a>
                                    <ul class="sidebar-submenu">
                                        <li><a href="{{route('user.edit')}}">Show Profile</a></li>
