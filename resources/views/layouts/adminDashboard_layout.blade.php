...
<body>
                        ...
                        <div class="">
                            ...
                            <a class="dropdown-item">
                                <div class="">
                                    <div class="media">
                                        <div class="user-img">
                                            <img src="{{asset('admin_assets/assets/img/90x90.jpg')}}" class="img-fluid mr-2" alt="avatar">
                                        </div>
                                        <div class="media-body">
                                            <div class="">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu {{ (request()->is('admin/dashboard')) ? 'active' : '' }}">
                        <a href="{{route('admin.dashboard')}}" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="terms" data-parent="#accordionExample">
                            <li>
                                <a href="{{route('termsConditions.create')}}"> Create </a>
                            </li>

                            <li>
                                <a href="{{route('termsConditions.list')}}"> List </a>
                            </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="banner" data-parent="#accordionExample">
                            <li class="{{ (request()->routeIs('banner.create')) ? 'active' : '' }}">
                                <a href="{{route('banner.create')}}"> Create </a>
                            </li>
                            <li class="{{ (request()->routeIs('banner.list')) ? 'active' : '' }}">
                                <a href="{{route('banner.list')}}"> List </a>
                            </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                            <li class="{{ (request()->routeIs('privacyPolicy.create')) ? 'active' : '' }}">
                                <a href="{{route('privacyPolicy.create')}}"> Create </a>
                            </li>
                            <li class="{{ (request()->routeIs('privacyPolicy.list')) ? 'active' : '' }}">
                                <a href="{{route('privacyPolicy.list')}}"> List </a>
                            </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                            <li class="{{ (request()->routeIs('subCategories.create')) ? 'active' : '' }}">
                                <a href="{{route('subCategories.create')}}"> Create </a>
                            </li>
                            <li class="{{ (request()->routeIs('subCategories.list')) ? 'active' : '' }}">
                                <a href="{{route('subCategories.list')}}"> List </a>
                            </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                            ...
                            <li class="{{ (request()->routeIs('brands.list')) ? 'active' : '' }}">
                                <a href="{{route('brands.list')}}"> List </a>
                            </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="app" data-parent="#accordionExample">
                            <li class="{{ (request()->routeIs('Suppliers.create')) ? 'active' : '' }}">
                                <a href="{{route('Suppliers.create')}}"> Create </a>
                            </li>
                            <li class="{{ (request()->routeIs('Suppliers.list')) ? 'active' : '' }}">
                                <a href="{{route('Suppliers.list')}}"> List </a>
                            </li>
    ...
    <script src="{{asset('admin_assets/assets/js/libs/jquery-3.1.1.min.js')}}">
    </script>
