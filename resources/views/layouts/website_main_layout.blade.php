...
<body class="blurpopup">
    <div class="popup">
        <div class="contentBox">
            ...
            <div class="content">
                <div>
                    <h3 style="font-weight: bold; font-family: 'Hind Siliguri', sans-serif;">বিশেষ ছাড়</h3>
                    <h2 style="font-weight: bold; font-family: 'Hind Siliguri', sans-serif;">৮০<sup>%</sup> <span>ডিসকাউন্ট</span></h2>
                    <p style="font-weight: bold; font-family: 'Hind Siliguri', sans-serif;">আমাদের শোরুমে চেয়ার এবং টেবিল এর উপরে ডিসকাউন্ট চলছে . এই সুযোগ সীমিত সময়ের জন্য </p>
                    <a href="#" style="font-weight: bold; font-family: 'Hind Siliguri', sans-serif;">এখানে ক্লিক করুন </a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        var typed = new Typed(".auto-input", {
            strings: ["আপনার পছন্দের প্রোডাক্টের নাম লিখে এখানে সার্চ করুন ", "Example: Processor"]
            , typeSpeed: 100
            , bakcSpeed: 100
            , loop: true
        });
