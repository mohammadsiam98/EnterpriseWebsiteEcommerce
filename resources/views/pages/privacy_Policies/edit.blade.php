                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form class="form form-horizontal" action="{{route('privacyPolicy.update',$privacyDetails->id)}}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class=" row">
                                            <div class="col-12">
                                                <div class="mb-1 row">
                                                    <div class="col-sm-12">
                                                        <textarea id="my-editor" name="privacyPolicies" class="form-control" style="font-size:24px;">{{ $privacyDetails->privacyPolicies }}</textarea>
                                                    </div>
                                                </div>
                                            </div>
