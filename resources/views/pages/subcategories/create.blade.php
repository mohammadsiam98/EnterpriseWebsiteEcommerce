                            ...
                            <div class="card-body">
                                <form action="{{route('subCategories.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" name="subCategoryName" id="basic-addon-name" class="form-control" placeholder="Enter a sub category name" aria-label="Name" style="font-size: 20px;" aria-describedby="basic-addon-name" />
                                    </div>
                                    <div class="mb-1">
