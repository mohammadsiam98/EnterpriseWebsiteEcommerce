                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 style="font-family: 'Poppins', sans-serif; font-size:30px">Update your Image</h5>
                                </div>
                                @if($checkThatImageExistsOrNot==null)
                                <div class="card-header">
                                    <h5 style="font-family: 'Poppins', sans-serif; font-size:30px">You have not uploaded your image yet</h5>
                                </div>
                                @else
                                <form class="form theme-form" action="{{route('usersImage.update',$usersImage->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <div class="mb-3">
                                                    <label class="form-label" for="exampleFormControlInput15">Update Image</label>
                                                    <input style="font-family: 'Poppins', sans-serif; font-size:20px" class="form-control input-air-primary" id="" type="file" name="image">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 style="font-family: 'Poppins', sans-serif; font-size:30px">The Image Which you have inserted is below</h5>
                                </div>
                                <img style="height:80px; width:auto; display:block; padding:10px; margin-left:auto;margin-right:auto" src="{{url($usersImage->image)}}" alt="image">
                            </div>
