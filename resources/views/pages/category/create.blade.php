                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="" action="{{route('category.store')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    <div class="mb-1">
                                        <label class="form-label" for="basic-addon-name">Title</label>
                                        <input type="text" name="categoryName" id="basic-addon-name" class="form-control" placeholder="Enter a category name" aria-label="Name" style="font-size: 20px;" aria-describedby="basic-addon-name" />
                                    </div>
                                    <div class="mb-1">
                                        <label class="form-label" for="basic-addon-name">Slug</label>
                                        <input type="text" name="slug" id="basic-addon-name" class="form-control" placeholder="Enter the slug of this category" aria-label="Name" style="font-size: 20px;" aria-describedby="basic-addon-name" />
                                    </div>
                                    <div class="mb-1">
