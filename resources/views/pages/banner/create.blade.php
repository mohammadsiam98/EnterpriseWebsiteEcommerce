                            ...
                            <div class="card-body">
                                <form id="" action="{{route('banner.store')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input type="text" name="title" id="basic-addon-name" class="form-control" placeholder="Enter the title of your slider" aria-label="Name" aria-describedby="basic-addon-name" />
                                    </div>
                                    <div class="mb-1">
                                        <label class="form-label" for="basic-addon-name">Slug</label>
                                        <input type="text" name="slug" id="basic-addon-name" class="form-control" placeholder="Enter the slug of this title" aria-label="Name" aria-describedby="basic-addon-name" />
                                    </div>
                                    <div class="mb-1">
